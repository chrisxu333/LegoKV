...
#define ROCKS_LOG_HEADER(LGR, FMT, ...) \
  LEGOKV_NAMESPACE::Log(InfoLogLevel::HEADER_LEVEL, LGR, FMT, ##__VA_ARGS__)

#define ROCKS_LOG_AT_LEVEL(LGR, LVL, FMT, ...)                           \
  LEGOKV_NAMESPACE::Log((LVL), (LGR), ROCKS_LOG_PREPEND_FILE_LINE(FMT), \
...
#define ROCKS_LOG_BUFFER(LOG_BUF, FMT, ...)                                 \
  LEGOKV_NAMESPACE::LogToBuffer(LOG_BUF, ROCKS_LOG_PREPEND_FILE_LINE(FMT), \
                                 RocksLogShorterFileName(__FILE__),         \
                                 ##__VA_ARGS__)

#define ROCKS_LOG_BUFFER_MAX_SZ(LOG_BUF, MAX_LOG_SIZE, FMT, ...) \
  LEGOKV_NAMESPACE::LogToBuffer(                                \
