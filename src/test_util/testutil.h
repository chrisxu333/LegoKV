...
#include "legokv/compaction_filter.h"
#include "legokv/env.h"
#include "legokv/iterator.h"
#include "legokv/merge_operator.h"
#include "legokv/options.h"
#include "legokv/slice.h"
#include "legokv/table.h"
#include "table/internal_iterator.h"
#include "util/concurrency/mutexlock.h"
...
class FilterNumber : public CompactionFilter {
 public:
  ...
  bool Filter(int /*level*/, const LEGOKV_NAMESPACE::Slice& /*key*/,
              const LEGOKV_NAMESPACE::Slice& value, std::string* /*new_value*/,
  ...
  bool FilterMergeOperand(
      int /*level*/, const LEGOKV_NAMESPACE::Slice& key,
      const LEGOKV_NAMESPACE::Slice& value) const override {
