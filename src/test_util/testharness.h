...
#define ASSERT_OK(s) \
  ASSERT_PRED_FORMAT1(LEGOKV_NAMESPACE::test::AssertStatus, s)
#define ASSERT_NOK(s) ASSERT_FALSE((s).ok())
#define EXPECT_OK(s) \
  EXPECT_PRED_FORMAT1(LEGOKV_NAMESPACE::test::AssertStatus, s)
...
#define ASSERT_MATCHES_REGEX(str, pattern) \
  ASSERT_PRED_FORMAT2(LEGOKV_NAMESPACE::test::AssertMatchesRegex, str, pattern)
#define EXPECT_MATCHES_REGEX(str, pattern) \
  EXPECT_PRED_FORMAT2(LEGOKV_NAMESPACE::test::AssertMatchesRegex, str, pattern)
