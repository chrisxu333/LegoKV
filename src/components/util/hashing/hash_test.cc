...
#include "util/coding/coding.h"
#include "util/coding/coding_lean.h"
#include "util/hashing/hash128.h"
#include "util/math/math.h"
#include "util/math/math128.h"

using LEGOKV_NAMESPACE::BijectiveHash2x64;
using LEGOKV_NAMESPACE::BijectiveUnhash2x64;
using LEGOKV_NAMESPACE::DecodeFixed64;
using LEGOKV_NAMESPACE::EncodeFixed32;
using LEGOKV_NAMESPACE::EndianSwapValue;
using LEGOKV_NAMESPACE::GetSliceHash64;
using LEGOKV_NAMESPACE::Hash;
using LEGOKV_NAMESPACE::Hash128;
using LEGOKV_NAMESPACE::Hash2x64;
using LEGOKV_NAMESPACE::Hash64;
using LEGOKV_NAMESPACE::Lower32of64;
using LEGOKV_NAMESPACE::Lower64of128;
using LEGOKV_NAMESPACE::ReverseBits;
using LEGOKV_NAMESPACE::Slice;
using LEGOKV_NAMESPACE::Unsigned128;
using LEGOKV_NAMESPACE::Upper32of64;
using LEGOKV_NAMESPACE::Upper64of128;
...
TEST(FastRange32Test, Values) {
  using LEGOKV_NAMESPACE::FastRange32;
  // Zero range
...
TEST(FastRange64Test, Values) {
  using LEGOKV_NAMESPACE::FastRange64;
  // Zero range
...
TEST(FastRangeGenericTest, Values) {
  using LEGOKV_NAMESPACE::FastRangeGeneric;
...
uint32_t FastRange32(uint32_t hash, uint32_t range) {
  return LEGOKV_NAMESPACE::FastRange32(hash, range);
}

// for inspection of disassembly
size_t FastRange64(uint64_t hash, size_t range) {
  return LEGOKV_NAMESPACE::FastRange64(hash, range);
}

// Tests for math.h / math128.h (not worth a separate test binary)
using LEGOKV_NAMESPACE::BitParity;
using LEGOKV_NAMESPACE::BitsSetToOne;
using LEGOKV_NAMESPACE::BitwiseAnd;
using LEGOKV_NAMESPACE::BottomNBits;
using LEGOKV_NAMESPACE::ConstexprFloorLog2;
using LEGOKV_NAMESPACE::CountTrailingZeroBits;
using LEGOKV_NAMESPACE::DecodeFixed128;
using LEGOKV_NAMESPACE::DecodeFixedGeneric;
using LEGOKV_NAMESPACE::DownwardInvolution;
using LEGOKV_NAMESPACE::EncodeFixed128;
using LEGOKV_NAMESPACE::EncodeFixedGeneric;
using LEGOKV_NAMESPACE::FloorLog2;
using LEGOKV_NAMESPACE::Lower64of128;
using LEGOKV_NAMESPACE::Multiply64to128;
using LEGOKV_NAMESPACE::Unsigned128;
using LEGOKV_NAMESPACE::Upper64of128;
...
int main(int argc, char **argv) {
  fprintf(stderr, "NPHash64 id: %x\n",
          static_cast<int>(LEGOKV_NAMESPACE::GetSliceNPHash64("RocksDB")));
