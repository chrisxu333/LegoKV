...
#include "legokv/functor_wrapper.h"
#include "legokv/port_defs.h"
...
// LEGOKV_NAMESPACE::SequentialFileWrapper {
//  public:
//   MySequentialFileWrapper(LEGOKV_NAMESPACE::SequentialFile* target):
//     LEGOKV_NAMESPACE::SequentialFileWrapper(target) {}
//   Status Read(size_t n, Slice* result, char* scratch) override {
//     cout << "Doing a read of size " << n << "!" << endl;
//     return LEGOKV_NAMESPACE::SequentialFileWrapper::Read(n, result,
//     scratch);
//   }
