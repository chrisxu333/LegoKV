...
#include "legokv/sst_file_writer.h"
#include "legokv/thread_status.h"
#include "legokv/transaction_log.h"
#include "legokv/types.h"
#include "legokv/version.h"
#include "legokv/wide_columns.h"
...
class DB {
 public:
  ...
  // in LEGOKV_NAMESPACE::kDefaultColumnFamilyName.
  ...
  // 'default' and it's stored in LEGOKV_NAMESPACE::kDefaultColumnFamilyName
  //
